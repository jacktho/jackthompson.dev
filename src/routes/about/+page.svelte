	...
	<div class="mx-auto max-w-3xl text-base leading-7 text-gray-200">
		...
		<div class="max-w-2xl">
			...
			<p class="mt-8">
				...
				early mobile applications, running my own web development and IT support business, and
				co-founding two startups in the insurance and financial advisory industries. These
				experiences have allowed me to develop a broad range of skills and expertise, including app
			...
			<p class="mt-8">
				...
				remained constant. I am confident in my ability to create competitive web applications and
